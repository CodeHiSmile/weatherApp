...
import 'package:demo/ui/components/search_field.dart';
      ...
      body: BlocProvider.value(
        ...
        child: BlocBuilder<HomeCubit, HomeState>(
          ...
          builder: (context, state) {
            return WidgetHUD(
              showHUD: state.loadStatus == LoadStatus.loading,
              hud: HUD(
                      ...
                      children: <Widget>[
                        BlocBuilder<HomeCubit, HomeState>(
                          buildWhen: (prev, current) =>
                              prev.showSearch != current.showSearch || prev.addressSearch != current.addressSearch,
                          builder: (context, state) {
                                      ...
                                      children: <Widget>[
                                        ...
                                        Expanded(
                                          child: SearchFieldComponent(
                                            ...
                                            onSearch: (value) {
                                              _cubit.getWeather(address: value);
                                              _cubit.showSearch(false);
